 ...
 * @version    MusicSongsFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_MusicSongsFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'music_playlist_song';

 ...
 * @version    MusicSongsComments.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_MusicSongsComments extends Install_Import_Phpfox_AbstractComments
{

  protected $_fromResourceType = 'music_song';
  protected $_toResourceType = 'music_playlist_song';
  protected $_isTableExist = array('engine4_music_playlists');
  protected $_fromWhere = array('type_id=?' => 'music_song');

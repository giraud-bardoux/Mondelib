 ...
 * @version    UserPhotoUpdateFeed.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_UserPhotoUpdateFeed extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'user';
  protected $_toResourceType = 'profile_photo_update';

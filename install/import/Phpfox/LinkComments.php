 ...
 * @version    LinkComments.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_LinkComments extends Install_Import_Phpfox_AbstractActivityComments
{

  protected $_fromResourceType = 'link';
  protected $_toResourceType = 'link';
  protected $_fromWhere = array('type_id=?' => 'link');

 ...
 * @version    EventFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_EventFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'event';
  protected $_toResourceType = 'event_create';
  protected $_isTableExist = array('engine4_event_events');
  protected $_fromWhere = array('type_id=?' => 'event');

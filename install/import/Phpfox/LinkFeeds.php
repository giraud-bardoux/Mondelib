 ...
 * @version    LinkFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_LinkFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'core_link';

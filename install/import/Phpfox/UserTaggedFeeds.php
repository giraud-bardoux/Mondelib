 ...
 * @version    UserTaggedFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_UserTaggedFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'user';
  protected $_toResourceType = 'tagged';
  protected $_fromWhere = array('type_id=?' => 'photo_tag');

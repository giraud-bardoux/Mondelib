 ...
 * @version    BlogFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_BlogFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'blog';
  protected $_toResourceType = 'blog_new';
  protected $_isTableExist = array('engine4_blog_blogs');
  protected $_fromWhere = array('type_id=?' => 'blog');

 ...
 * @version    BlogTags.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_BlogTags extends Install_Import_Phpfox_AbstractTags
{

  protected $_fromResourceType = 'blog';
  protected $_toResourceType = 'blog';
  protected $_isTableExist = array('engine4_blog_blogs');
  protected $_fromWhere = array('category_id=?' => 'blog');

 ...
 * @version    AlbumComments.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_AlbumComments extends Install_Import_Phpfox_AbstractComments
{

  protected $_fromResourceType = 'photo_album';
  protected $_toResourceType = 'album';
  protected $_isTableExist = array('engine4_album_albums');
  protected $_fromWhere = array('type_id=?' => 'photo_album');
}

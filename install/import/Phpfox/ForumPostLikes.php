 ...
 * @version    ForumPostLikes.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_ForumPostLikes extends Install_Import_Phpfox_AbstractActivityLikes
{

  protected $_fromResourceType = 'forum_post';
  protected $_toResourceType = 'forum_post';

 ...
 * @version    ForumFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_ForumFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'forum_topic';
  protected $_toResourceType = 'forum_topic_create';
  protected $_isTableExist = array('engine4_forum_topics');
  protected $_fromWhere = array('type_id=?' => 'forum');

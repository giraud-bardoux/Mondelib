 ...
 * @version    AlbumFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_AlbumFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'album';
  protected $_toResourceType = 'album_photo_new';

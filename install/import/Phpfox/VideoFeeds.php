 ...
 * @version    VideoFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_VideoFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'video';
  protected $_toResourceType = 'video_new';
  protected $_isTableExist = array('engine4_video_videos');
  protected $_fromWhere = array('type_id=?' => 'video');

 ...
 * @version    ClassifiedCategories.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_ClassifiedCategories extends Install_Import_Phpfox_Abstract
{
  ...
  {
    $this->_fromTable = $this->getFromPrefix() . 'marketplace_category';
    $this->_toTable = 'engine4_classified_categories';

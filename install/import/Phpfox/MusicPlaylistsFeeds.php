 ...
 * @author     John
 */
class Install_Import_Phpfox_MusicPlaylistsFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'music_playlist';
  protected $_toResourceType = 'music_playlist_new';

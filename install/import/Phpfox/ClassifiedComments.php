 ...
 * @version    ClassifiedComments.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_ClassifiedComments extends Install_Import_Phpfox_AbstractComments
{

  protected $_fromResourceType = 'marketplace';
  protected $_toResourceType = 'classified';
  protected $_isTableExist = array('engine4_classified_classifieds');
  protected $_fromWhere = array('type_id=?' => 'marketplace');

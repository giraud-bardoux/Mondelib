 ...
 * @version    PollFeeds.php 2015-07-30 00:00:00Z john $
 * @author     John
 */
class Install_Import_Phpfox_PollFeeds extends Install_Import_Phpfox_AbstractFeeds
{

  protected $_fromResourceType = 'poll';
  protected $_toResourceType = 'poll_new';
  protected $_isTableExist = array('engine4_poll_polls');
  protected $_fromWhere = array('type_id=?' => 'poll');

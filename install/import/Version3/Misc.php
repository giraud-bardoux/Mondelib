...
CREATE TABLE IF NOT EXISTS `se_languages` (
  ...
  `language_code` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `language_name` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL default '0',
  `language_autodetect_regex` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `language_setlocale` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_languagevars` (
  ...
  `languagevar_value` text COLLATE utf8mb4_unicode_ci,
  `languagevar_default` text COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE IF NOT EXISTS `se_logins` (
  ...
  `login_email` varchar(70) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `login_date` int(14) NOT NULL default '0',
  `login_ip` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `se_notifys` (
  ...
  `notify_urlvars` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL default '0',
  `notify_text` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_notifytypes` (
  ...
  `notifytype_icon` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `notifytype_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `notifytype_title` int(9) NOT NULL default '0',
  `notifytype_url` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_plugins` (
  ...
  `plugin_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `plugin_version` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `plugin_type` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `plugin_desc` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `plugin_icon` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `plugin_menu_title` int(9) NOT NULL,
  `plugin_pages_main` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `plugin_pages_level` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `plugin_url_htaccess` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_session_auth` (
  `session_auth_key` char(40) COLLATE utf8mb4_unicode_ci NOT NULL,
  `session_auth_user_id` int(9) NOT NULL,
  `session_auth_ip` int(9) NOT NULL,
  `session_auth_ua` char(32) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_stylesamples` (
  ...
  `stylesample_type` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `stylesample_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `stylesample_thumb` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `stylesample_css` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_systememails` (
  ...
  `systememail_name` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `systememail_vars` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_urls` (
  ...
  `url_title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `url_file` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `url_regular` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `url_subdirectory` varchar(200) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  PRIMARY KEY  (`url_id`)
...
CREATE TABLE IF NOT EXISTS `se_usersettings` (
  ...
  `usersetting_lostpassword_code` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  ...
  `usersetting_actions_dontpublish` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `usersetting_actions_display` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_visitors` (
  ...
  `visitor_user_username` varchar(64) collate utf8mb4_unicode_ci default NULL,
  `visitor_user_displayname` varchar(128) collate utf8mb4_unicode_ci default NULL,
...
CREATE TABLE IF NOT EXISTS `se_xspfskins` (
  ...
  `xspfskin_title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `xspfskin_desc` text COLLATE utf8mb4_unicode_ci,
  `xspfskin_height` smallint(5) unsigned NOT NULL default '0',
  `xspfskin_width` smallint(5) unsigned NOT NULL default '0',
  `xspfskin_version` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL default '',

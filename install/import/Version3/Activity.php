...
CREATE TABLE IF NOT EXISTS `se_actionmedia` (
  ...
  `actionmedia_path` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  `actionmedia_link` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `se_actions` (
  ...
  `action_object_owner` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL default '',
...
CREATE TABLE IF NOT EXISTS `se_actiontypes` (
  ...
  `actiontype_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  `actiontype_icon` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL default '',
  ...
  `actiontype_vars` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL default '',

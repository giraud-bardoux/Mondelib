...
class Install_Import_Version3_ClassifiedClassifieds extends Install_Import_Version3_Abstract
{
  ...
  protected function  _translateRow(array $data, $key = null)
  {
    ...
    $newData['body'] = str_replace(array('<br>', '<br />'), array("\n", "\n"), strip_tags(@htmlspecialchars_decode($data['classified_body'], ENT_QUOTES), '<br>'));
    ...
    //SET PRIVACY
    $privacy = $this->_translatePrivacy($data['classified_privacy'], 'owner');

...
('notify_admin_user_signup', '[displayname],[email],[subject],[link]'),
...
CREATE TABLE IF NOT EXISTS `engine4_core_menuitems` (
  ...
  `plugin` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `params` text NOT NULL,
  `menu` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
  `submenu` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE `engine4_storage_files` (
  ...
  `parent_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,

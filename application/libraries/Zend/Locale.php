...
class Zend_Locale
{
     ...
     */
    /**
    *These are unsupported in zend 1, commenting for now until we have zend 2
    */
    /*
    ...
    */
    ...
    public function setLocale($locale = null)
    {
        ...
        if (isset(self::$_localeData[(string) $locale]) === false) {
            ...
            /** have to remove due to locale bug in zend 1
    ...
    public static function isLocale($locale, $strict = false, $compatible = true)
    {
        ...
        // Is it an alias?
        /* removing for now due to zend 1 locale bug
     ...
     * @return boolean
     */
    /* removing due to locale bug in zend 1
     ...
     * @return string
     */
    /* removing due to bug in zend1 locale

...
class Zend_Captcha_Image extends Zend_Captcha_Word
{
    ...
    public function render(Zend_View_Interface $view = null, $element = null)
    {
        ...
        return '<div class="sitecaptcha"><img width="' . $this->getWidth() . '" height="' . $this->getHeight() . '" alt="' . $this->getImgAlt()
             . '" src="' . $this->getImgUrl() . $this->getId() . $this->getSuffix() . '"' . $endTag . 
             '<a href="javascript:void(0);" class="captcha_refresh_icon center_item" onclick="refreshCaptcha(this)" data-bs-toggle="tooltip" title="'.$view->translate('Refresh').'"><i class="fa-solid fa-arrow-rotate-right"></i></a></div>'

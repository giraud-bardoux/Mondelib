...
class CoinpaymentsAPI
{
     ...
     * @throws Exception
     */
    public function CreateComplexTransaction($amount, $currency1, $currency2, $buyer_email, $address, $buyer_name, $item_name, $item_number, $invoice, $custom, $ipn_url,$success_url,$cancel_url)
    {
        $fields = [
            'amount' => $amount,
            'currency1' => $currency1,

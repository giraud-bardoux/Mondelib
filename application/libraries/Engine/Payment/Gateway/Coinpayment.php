 ...
 */
 ...
 include_once APPLICATION_PATH . "/application/libraries/Engine/Service/Coinpayment/vendor/autoload.php";

class Engine_Payment_Gateway_Coinpayment extends Engine_Payment_Gateway
{
  // Support

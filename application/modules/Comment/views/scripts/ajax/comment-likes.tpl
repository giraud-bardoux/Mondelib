 ...
 * @version    $Id: comment-likes.tpl 2024-10-29 00:00:00Z 
 * @author     SocialEngine
 */
    ...
    <div class="container_like_contnent_main users_listing_popup_cont_inner" id="container_like_contnent">
      <ul id="like_contnent">
        ...
        echo $this->partial(
          ...
          'activity',
          array('users' => $this->users, 'paginator' => $this->paginator, 'randonNumber' => 'contentlikeusers', 'resource_id' => $this->resource_id, 'resource_type' => $this->resource_type, 'execute' => true, 'page' => $this->page, 'comment_id' => $this->comment_id, 'isPageSubject' => $isPageSubject)
        );
        ?>
        <?php $randonNumber = 'contentlikeusers'; ?>
      </ul>
      <div class="load_more" id="view_more_<?php echo $randonNumber; ?>"onclick="viewMore_<?php echo $randonNumber; ?>();" style="display: none;" >

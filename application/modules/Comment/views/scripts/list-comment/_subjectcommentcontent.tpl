 ...
 * @version    $Id: _subjectcommentcontent.tpl 2024-10-29 00:00:00Z 
 * @author     SocialEngine
 */
...
<?php if (empty($this->nolist)) { ?>
  ...
  <span class="comments_body_actual" rel="" data-subject="<?php echo !empty($comment->resource_type) ? $comment->resource_type : ""; ?>"
    data-subjectid="<?php echo !empty($comment->resource_id) ? $comment->resource_id : ""; ?>" style="display:none;">

 ...
 * @version    $Id: _activitycommentreplycontent.tpl 2024-10-29 00:00:00Z 
 * @author     SocialEngine
 */
...
<?php if (empty($this->nolist)) { ?>
  ...
  <?php if ($commentreply instanceof Activity_Model_Comment) {
    $module = 'activity';
  } else {
    $module = "core";
  } ?>
  ...
  <span class="comments_reply_body_actual" rel="<?php echo $module; ?>" style="display:none;">
  ...
  <?php if ($commentreply->preview && empty($commentreply->showpreview)) { ?>
    <div class="comment_link_item" id="commentpreview_<?php echo $commentreply->comment_id; ?>">
      <?php
        ...
        <a href="<?php echo $link->getHref() ?>" target="_blank" class="clearfix">
          ...
          <div class="comment_link_item_cont">
            ...
            <div class="comment_link_item_source font_color_light">
              <?php echo str_replace(array('www.', 'demo.'), array('', ''), $parseUrl['host']); ?>
            </div>
          </div>
        </a>
      <?php } ?>

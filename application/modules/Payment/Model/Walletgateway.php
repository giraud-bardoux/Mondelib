 ...
 * @version    $Id: Walletgateway.php 9747 2012-07-26 02:08:08Z john $
...
class Payment_Model_Walletgateway extends Core_Model_Item_Abstract
{
  ...
  public function getPlugin()
  {
    if( null === $this->_plugin ) {
      ...
      $class = str_replace('Gateway','Gateway_Wallet',$class);
      $class = str_replace('Gateway_Wallet_Wallet','Gateway_Wallet',$class);

...
* @version    $Id: Walletgateways.php 9747 2012-07-26 02:08:08Z john $
...
* @license    http://www.socialengine.com/license/
*/
class Payment_Model_DbTable_Walletgateways extends Engine_Db_Table
{   
  protected $_name = 'payment_gateways';
  
  protected $_rowClass = 'Payment_Model_Walletgateway';

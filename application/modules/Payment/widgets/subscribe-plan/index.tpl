      ...
      <div class="_cont">
        ...
        <ul>
          ...
          <li>
            ...
            <?php if($this->currentPackage->isOneTime()) { ?>
              <b><?php echo date('Y-m-d',strtotime($this->currentSubscription->expiration_date)); ?></b>
            <?php } else { ?>
              <?php $expration_date = date("j F, Y  H:iA",  strtotime($this->currentSubscription->creation_date . ' +'.$this->currentPackage->duration . ' '. $this->currentPackage->duration_type)); ?>
              <b><?php echo $expration_date; ?></b>
            <?php } ?>
          </li>

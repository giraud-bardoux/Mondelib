 ...
 * @license    http://www.socialengine.com/license/
 */
class Payment_Plugin_Gateway_Verification_Bank extends Engine_Payment_Plugin_Abstract
{
    ...
    if( $giveBenefit ) {
      ...
      if(engine_count($getAllAdmin) > 0) {
        ...
        foreach($getAllAdmin as $admin) {
          Engine_Api::_()->getDbTable('notifications', 'activity')->addNotification($admin, $user, $user, 'payment_manual_verification', array('payment_method' => 'Bank','adminsidelink' => $adminSideLink));

...
class Payment_Plugin_Gateway_Stripe extends Engine_Payment_Plugin_Abstract {
      ...
      Payment_Model_Order $order, array $params = array())
  {
    ...
    $subsSession = new Zend_Session_Namespace('Payment_Subscription');
    $current_currency = $subsSession->current_currency;
    $currencyChangeRate = $subsSession->change_rate;
  ...
  public function cancelSubscriptionOnExpiry($subscription, $package) {
...
//     }
    ...
    switch ($rawData['type']) {
      ...
      case 'customer.subscription.updated':
        ...
        //}
        //$this->cancelSubscriptionOnExpiry($subscription, $package);
        return true;
        break;

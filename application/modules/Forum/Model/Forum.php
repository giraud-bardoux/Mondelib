 ...
 * @version    $Id: Forum.php 9747 2012-07-26 02:08:08Z john $
 * @author     John
 */
...
class Forum_Model_Forum extends Core_Model_Item_Collectible
{
  ...
  {
    return new Engine_ProxyObject($this, Engine_Api::_()->getDbtable('membership', 'forum'));
  }  
  ...
  public function topicCount() {
    $topicTable = Engine_Api::_()->getItemTable('forum_topic');
    return $topicTable->select()
        ->from($topicTable, new Zend_Db_Expr('COUNT(topic_id)'))
  ...
  public function topicPostCount() {

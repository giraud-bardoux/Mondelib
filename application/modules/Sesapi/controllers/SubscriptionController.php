 ...
 * @version    $Id: SubscriptionController.php 2018-08-14 00:00:00 socialnetworking.solutions $
 * @author     socialnetworking.solutions
 */
class Sesapi_SubscriptionController extends Core_Controller_Action_Standard
{
  /**
   * @var User_Model_User
   */
  ...
  public function init()
  {
    ...
    if(isset($_GET['user_subscription_id'])){
  ...
  public function returnAction()
  {
    ...
    if( !$this->_user ||
      ...
      return $this->_helper->redirector->gotoRoute(array('action'=>'finish','state'=>'failure'), 'default', true);
    }
  ...
  protected function _finishPayment($state = 'active')
  {
    ...
    // Redirect
    if( $state == 'free' ) {
      return $this->_helper->redirector->gotoRoute(array('action'=>'finish','state'=>'active'), 'default', true);
    } else {

...
?>
<?php echo $this->partial('_admin_breadcrumb.tpl', 'core', array('parentMenuItemName' => 'core_admin_main_plugins', 'childMenuItemName' => 'core_admin_main_plugins_sesapi')); ?>
...
<?php if(is_countable($this->navigation) && engine_count($this->navigation) ): ?>
  ...
  <?php endif; ?>
<div class="sesapi_support_links">
  <a href="https://help.socialenginesolutions.com" target="_blank">
    <img src="application/modules/Sesapi/externals/images/support/faq.png" />
    <h4>FAQs</h4>
  ...
  <a href="https://socialnetworking.solutions/support/" target="_blank">
    <img src="application/modules/Sesapi/externals/images/support/support.png" />
    <h4>Support</h4>
  ...
  <a href="https://socialenginesolutions.us16.list-manage.com/subscribe?u=70b1c9baba63dcf30fec2c66d&id=3c72ee2249" target="_blank">
    <img src="application/modules/Sesapi/externals/images/support/info.png" />
  ...
  <a href="http://www.socialenginesolutions.com/contact-us/" target="_blank">
    <img src="application/modules/Sesapi/externals/images/support/contact.png" />
    <h4>Contact Us</h4>
  ...
  <a href="http://www.socialenginesolutions.com/blog/" target="_blank">
    <img src="application/modules/Sesapi/externals/images/support/update.png" />
    <h4>Blog Updates</h4>
    <p>We regularly post blogs about new releases & announcements. To read the new updates, check out our Blog Posts.</p>
  </a>
  <a href="https://socialengine.com/experts/profile/socialenginesolutions" target="_blank">
    <img src="application/modules/Sesapi/externals/images/support/review.png" style="filter:invert(0);" />

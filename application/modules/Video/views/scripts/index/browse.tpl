...
<?php elseif( $this->category || $this->tag || $this->text ):?>
  <div class="no_result_tip">
    ...
    <p><?php echo $this->translate('No one has posted a video with that criteria.');?></p>
    <?php if ($this->can_create):?>
      <p><?php echo $this->translate('Be the first to %1$spost%2$s one!', '<a href="'.$this->url(array('action' => 'create'), "video_general").'">', '</a>'); ?></p>
    <?php endif; ?>
  </div>
<?php else:?>
  <div class="no_result_tip">

...
<script type="application/javascript">
  ajaxurl = en4.core.baseUrl+"admin/event/settings/change-order";
</script>
        ...
        <form id="addcategory" method="post" enctype="multipart/form-data">
          <div class="admin-form-field" id="name-required">
            ...
            <div class="admin-form-field-element">
              <input name="title" autocomplete="off" id="tag-name" type="text"  size="40" >
            </div>
          </div>
            ...
            <div class="admin-form-field-element">
              <select name="parent" id="parent" class="postform">
                ...
                <?php foreach ($this->categories as $category): ?>
                  ...
                  <?php 
                    $subcategory = Engine_Api::_()->getDbtable('categories', 'event')->getSubcategory(array('column_name' => "*", 'category_id' => $category->category_id));          
                    foreach ($subcategory as $subCategory):  
                  ?>
                  <option class="level-1" value="<?php echo $subCategory->category_id; ?>">&nbsp;&nbsp;&nbsp;<?php echo $subCategory->title; ?></option>
                <?php 
                  endforeach;
                  endforeach; 
                ?>
          ...
          <table class='admin_table admin_table_order' style="width: 100%;">
            ...
            <tbody>
              ...
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-id="<?php echo $category->category_id; ?>">
                ...
                <td>
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'event', 'controller' => 'settings', 'action' => 'edit-category', 'id' => $category->category_id), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$category->category_id)); ?>
                </td>
              </tr>
              <?php //Subcategory Work
                ...
                foreach ($subcategory as $subCategory):  ?>
                  <tr id="categoryid-<?php echo $subCategory->category_id; ?>" data-id="<?php echo $subCategory->category_id; ?>">
                    ...
                    <td>
                      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'event', 'controller' => 'settings', 'action' => 'edit-category', 'id' => $subCategory->category_id), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subCategory->category_id)) ?>
                    </td>
                  </tr>
                  <?php //SubSubcategory Work
                  $subsubcategory = Engine_Api::_()->getDbtable('categories', 'event')->getSubsubcategory(array('column_name' => "*", 'category_id' => $subCategory->category_id));
                  foreach ($subsubcategory as $subsubCategory): ?>
                    <tr id="categoryid-<?php echo $subsubCategory->category_id; ?>" data-id="<?php echo $subsubCategory->category_id; ?>">
                      ...
                      <td>--&nbsp;<?php echo $subsubCategory->title ?>
                        <div class="hidden" style="display:none" id="inline_<?php echo $subCategory->category_id; ?>">
                          <div class="parent"><?php echo $subsubCategory->subsubcat_id; ?></div>
                        </div>
                      </td>
                      <td>
                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'event', 'controller' => 'settings', 'action' => 'edit-category', 'id' => $subsubCategory->category_id), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subsubCategory->category_id)) ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php endforeach; ?>

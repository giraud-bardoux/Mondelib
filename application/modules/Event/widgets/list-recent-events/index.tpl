    ...
    <li class="sidebar_list_item">
      ...
      <div class="sidebar_list_item_info">
        ...
        <div class="sidebar_list_item_stats">
          <span><i class="icon_calendar"></i><?php echo $this->timestamp(strtotime($item->starttime)) ?></span>
        </div>
      </div>
    </li>
  <?php endforeach; ?>
  <?php if( $this->paginator->getPages()->pageCount > 1 ): ?>
    <li class="sidebar_list_item_more"><?php echo $this->partial('_widgetLinks.tpl', 'core', array('url' => $this->url(array(), 'event_general', true),'param' => array('order' => 'creation_date+DESC'))); ?></li>
  <?php endif; ?>
</ul>

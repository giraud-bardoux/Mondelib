...
class Event_PhotoController extends Core_Controller_Action_Standard
{
  ...
  public function uploadAction()
  {
    ...
    try
    {
      ...
      $action = $api->addActivity(Engine_Api::_()->user()->getViewer(), $event, 'event_photo_upload', null, array('count' => engine_count($values['file'])));
  ...
  public function deleteAction()
  {
    ...
    if($event->coverphoto == $photo->photo_id) {
      $event->coverphoto = 0;
      $event->save();
  ...
  public function removePhotoAction() {
		...
		$photo = Engine_Api::_()->getItem('event_photo', $_GET['photo_id']);
		$db = Engine_Api::_()->getDbTable('photos', 'event')->getAdapter();
		$db->beginTransaction();
		try {
			$photo->delete();

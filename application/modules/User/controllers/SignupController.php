...
class User_SignupController extends Core_Controller_Action_Standard
{
  ...
  public function indexAction()
  {
    ...
    if( !$viewer->enabled ) {
      ...
      $url = $this->view->url(array('action' => 'confirm'), 'user_signup', true);
      echo json_encode(array('status' => true, 'redirectFullURL' => $url, ''));die; 
  ...
  public function verifyAction()
  {
    ...
    try {
      ...
      // Send Welcome E-mail
      $enabletwostep = Engine_Api::_()->getApi('settings', 'core')->getSetting('user.signup.enabletwostep', 0);
      if(!empty($enabletwostep)) {

...
<div class='admin_search sesiosapp_search_form'>
         ...
         ?>
          <tr>
            ...
            <td class="admin_table_centered"><?php echo $item->revoked == 1 ?   $this->htmlLink(
                array('route' => 'default', 'module' => 'sesiosapp', 'controller' => 'admin-subscribers', 'action' => 'revoked', 'id' => $item->aouthtoken_id),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesiosapp/externals/images/admin/error.png', '', array('title'=> $this->translate('Click to grant access'))),array('class'=>'openRevoked')) : $this->htmlLink(
                array('route' => 'default', 'module' => 'sesiosapp', 'controller' => 'admin-subscribers', 'action' => 'revoked', 'id' => $item->aouthtoken_id),$this->htmlImage($this->layout()->staticBaseUrl . 'application/modules/Sesiosapp/externals/images/admin/check.png', '', array('title'=> $this->translate('Click to revoke access'))),array('class'=>'openRevoked')) ; ?></td>
            <td class="admin_table_centered"><?php echo $item->sessions; ?></td>
            <td class="admin_table_centered"><?php echo $item->creation_date; ?></td>
            <td>
              <?php echo $this->htmlLink(array('route' => 'default', 'module' => 'sesiosapp', 'controller' => 'admin-subscribers', 'action' => 'delete', 'id' => $item->aouthtoken_id), $this->translate("Delete"), array('class' => 'smoothbox')) ?>
            </td>
          </tr>
        <?php endforeach; ?>
    </tbody>

...
class Sesiosapp_AdminSubscribersController extends Core_Controller_Action_Admin {
  public function indexAction() {
    $this->view->navigation = Engine_Api::_()->getApi('menus', 'core')
            ->getNavigation('sesiosapp_admin_main', array(), 'sesiosapp_admin_main_subscriber');
    $this->view->form = $form = new Sesiosapp_Form_Admin_Subscribersearch();
  ...
  function revokedAction(){
    ...
    $this->view->form = $form = new Sesiosapp_Form_Admin_Revoked();  
    $form->id->setValue($id);
    if ($this->getRequest()->isPost()) {

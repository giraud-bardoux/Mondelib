 ...
 * @version    $Id: Notifications.php 2024-10-28 00:00:00Z 
 * @author     SocialEngine
 */
...
class Activity_Model_DbTable_Notifications extends Engine_Db_Table
{
                                    ...
                                    Core_Model_Item_Abstract $object, $type, array $params = null)
    {
        ...
        // if(empty($params['canSend'])) {
        //   Engine_Api::_()->getDbTable('notificationrecipients', 'core')->addRecipientNotification($user, $subject, $object, $type, $params);
        //   return;
        // }
        
        // if(isset($params['canSend']))
        //   unset($params['canSend']);
        ...
        $row->is_admin = $notificationType->is_admin ? $notificationType->is_admin : 0;
        $row->save();

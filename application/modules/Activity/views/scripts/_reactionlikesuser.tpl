 ...
 * @version    $Id: _reactionlikeuser.tpl 2024-10-28 00:00:00Z 
 * @author     SocialEngine
 */
...
if ($this->execute) {
    ...
    <li class="users_listing_popup_item">
      <div class="users_listing_popup_item_photo">
        <span>
          ...
          <i style="background-image:url(<?php echo Engine_Api::_()->getDbtable('reactions', 'comment')->likeImage($this->type[$user->getIdentity() . '_' . $user->getType()]); ?>);"></i>
        </span>
      </div>
  ...
  <div data-typeselected="<?php echo $this->typeSelected; ?>" data-resourcetype="<?php echo $this->resource_type; ?>" data-id="<?php echo $this->resource_id; ?>" data-itemid="<?php echo $this->item_id; ?>" class="loading_container nocontent" style="display: block;"></div>
<?php
}
?>
...
<script type="application/javascript">
  ...
  function viewMore_<?php echo $randonNumber; ?> () {
    ...
    requestViewMore_<?php echo $randonNumber; ?> = scriptJquery.ajax({
      method: 'post',
      'url': en4.core.baseUrl + "activity/ajax/likes/",
      'data': {
        format: 'html',

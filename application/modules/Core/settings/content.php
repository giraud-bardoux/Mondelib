...
return array(
  array(
    ...
    'special' => 1,
    'autoEdit' => true,
    'adminForm' => 'Core_Form_Admin_Widget_HtmlText',
  ),
  array(
  ...
  array(
    'title' => 'Parallax',
    'description' => 'This widget displays the Parallax. Edit this widget to configure features.',
    'category' => 'Core',
    'type' => 'widget',
    'name' => 'core.parallax',
    'adminForm' => array(
  ...
  array(
    ...
    'description' => 'This widget displays the Background Image. Edit this widget to configure Background Image.',
    'category' => 'Core',
    'type' => 'widget',
    'name' => 'core.page-background-image',
    'autoEdit' => true,
    'adminForm' => 'Core_Form_Admin_Widget_BackgroundImage',
  ),
  array(
    'title' => 'Mobile App Links',
    'description' => 'This widget displays the Android & iOS App links. You can edit this widget to configure the links.',
    'category' => 'Core',
    'type' => 'widget',
    'autoEdit' => true,
    'name' => 'core.mobile-apps-links',
    'adminForm' => array(
      'elements' => array(
        array(
          'Text',
          'androidlink',
          array(
            'label' => 'Enter the Android App Link.',
          )
        ),
        array(
          'Text',

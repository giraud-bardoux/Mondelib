 ...
 * @license    http://www.socialengine.com/license/
 */
class Core_Model_DbTable_Categories extends Engine_Db_Table
{
  ...
  public function order($categoryTypeId, $categoryType = 'category_id', $type = 'tickets') {

...
class Core_Form_Admin_Settings_Spam extends Engine_Form
{
  ...
  public function init()
  {
    ...
    $maindescription = vsprintf($maindescription.$moreinfo, array(
      'https://community.socialengine.com/blogs/597/33/spam-and-banning-tools',
    ));
    ...
    $this->addElement('Radio', 'signup', array(
      ...
      'description' => 'Do you want to show CAPTCHA on signup, invite, login and contact?',
    ...
    $this->addElement('Radio', 'recaptcha_version', array(
      'label' => 'ReCaptcha Version v3',
      'description' => 'Do you want to enable ReCaptcha on your site?',
      'multiOptions' => array(
          1 => 'No',
          0 => 'Yes',
      ),

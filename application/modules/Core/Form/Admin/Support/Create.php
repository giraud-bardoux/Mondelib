...
class Core_Form_Admin_Support_Create extends Engine_Form {
  ...
  public function init() {
    ...
    $this->addElement('Text', "name", array(
      'label' => 'Select a user from auto suggest box below by typing the name of the member on whose behalf you want to open this ticket.',

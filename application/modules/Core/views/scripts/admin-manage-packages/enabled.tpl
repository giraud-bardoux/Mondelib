      ...
      <ul>
        ...
        <li class="active">
          <a href="admin/core/manage-packages/enabled">
            <p><?php echo $this->translate("Enabled Plugins"); ?><span class="admin_plugin_count active_plugin"> 
              (<?php echo engine_count($this->allEnabledModules); ?>) </span></p>
          </a>
        </li>
        <li>
              ...
              <div class="admin_active_btn">
                ...
                <div class="admin_active_btn_right">
                  ...
                  <div class="admin_btn_group">
                    ...
                    <?php } else { ?>
                      <a href="javascript:void(0);" class="disable" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?php echo $this->translate("Enable for settings"); ?>" ><?php echo $this->translate(" Settings "); ?></a> | 
                    <?php } ?>
                    <?php if($item->enabled) { ?>

...
<?php echo $this->partial('_admin_breadcrumb.tpl', 'core', array('parentMenu' => "core_admin_main_manage", 'parentMenuItemName' => 'core_admin_main_manage_tickets', 'lastMenuItemName' => 'Categories')); ?>
...
<div class='admin-categories-form'>
  <div>
    <div class="admin-form-cont">
      <h3><?php echo $this->translate("Ticket Categories") ?> </h3>
      <p class="description"><?php echo $this->translate("If you want to allow your users to categorize their tickets, create the categories below. This feature is useful if you want to list all your users' tickets by category. If you have no categories, your users will not be given the option of assigning a category."); ?></p>
            ...
            <div class="admin-form-field-element">
              <select name="parent" id="parent" class="postform">
                ...
                <?php foreach ($this->categories as $category): ?>
                  ...
                  <?php 
                    $subcategory = Engine_Api::_()->getDbtable('categories', 'core')->getSubcategory(array('column_name' => "*", 'category_id' => $category->category_id, 'type' => 'tickets'));
          ...
          <table class='admin_table admin_table_order' style="width: 100%;">
            ...
            <tbody>
              ...
              <tr id="categoryid-<?php echo $category->category_id; ?>" data-id="<?php echo $category->category_id; ?>">
                ...
                <td>
                  <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'core', 'controller' => 'support', 'action' => 'edit-category', 'id' => $category->category_id, 'type' => $category->type), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$category->category_id)); ?>
                </td>
              </tr>
              <?php //Subcategory Work
                ...
                foreach ($subcategory as $subCategory):  ?>
                  <tr id="categoryid-<?php echo $subCategory->category_id; ?>" data-id="<?php echo $subCategory->category_id; ?>">
                    ...
                    <td>
                      <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'core', 'controller' => 'support', 'action' => 'edit-category', 'id' => $subCategory->category_id, 'type' => $subCategory->type), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subCategory->category_id)) ?>
                    </td>
                  </tr>
                  <?php //SubSubcategory Work
                  $subsubcategory = Engine_Api::_()->getDbtable('categories', 'core')->getSubsubcategory(array('column_name' => "*", 'category_id' => $subCategory->category_id, 'type' => 'tickets'));
                  foreach ($subsubcategory as $subsubCategory): ?>
                    <tr id="categoryid-<?php echo $subsubCategory->category_id; ?>" data-id="<?php echo $subsubCategory->category_id; ?>">
                      ...
                      <td>
                        <?php echo $this->htmlLink(array('route' => 'admin_default', 'module' => 'core', 'controller' => 'support', 'action' => 'edit-category', 'id' => $subsubCategory->category_id, 'type' => $subsubCategory->type), $this->translate('Edit'), array('class' => 'smoothbox')) ?> | <?php echo $this->htmlLink('javascript:void(0);', $this->translate('Delete'), array('class' => 'deleteCat','data-url'=>$subsubCategory->category_id)) ?>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php endforeach; ?>

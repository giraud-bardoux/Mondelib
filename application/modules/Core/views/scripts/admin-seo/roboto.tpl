 ...
 * @version    $Id: roboto.tpl 9747 2012-07-26 02:08:08Z john $
 * @author     John
 */
?>
<?php echo $this->partial('_admin_breadcrumb.tpl', 'core', array('parentMenu' => "core_admin_main_settings", 'childMenuItemName' => 'core_admin_main_settings_seo_roboto')); ?>
...
<?php $basePath = APPLICATION_PATH . DIRECTORY_SEPARATOR .'robots.txt'; ?>
...
<p><?php echo $this->translate("The robots.txt file is a text file that tells web robots (most often search engines) which pages on your site to crawl or not to crawl. From here, you can enter which part of website cannot access by search engine crawlers."); ?></p>

!(function (e) {
    const t = 86400,
        ...
        o = 60;
    var n = {
        rus: { second: ["секунда", "секунды", "секунд"], minute: ["минута", "минуты", "минут"], hour: ["час", "часа", "часов"], day: ["день", "дня", "дней"] },
    ...
    const r = {
        ...
        afterDeadline: function (e) {
          e.bodyBlock.html('<p class="_countdonw_finish" style="font-size: 1.2em;">The countdown is finished!</p>');
    ...
    var a = {
            init: function (t) {
                var i = e.extend({}, r, t || {});
                return (
                    t.hasOwnProperty("dubleNumbers") && (i.doubleNumbers = t.dubleNumbers),
                    this.each(function () {
                        var t = e(this);
            ...
            _render: function () {
                ...
                (t =
                    ...
                    o.footTitle +
                    "</div>"),
                    i.addClass("syotimer").addClass("timer").html(t);
            ...
            _perSecondHandler: function () {
                ...
                var o = new Date(moment.utc().format()),
                    n = new Date(i.initialdate) ,
            ...
            _applyEffectSwitch: function (t) {
                ...
                switch (t) {
                    case "none":
                        ...
                        break;
                    case "opacity":
                        e(".second .tab-val", o).animate({ opacity: 0.1 }, 1e3, "linear", function () {
                            a._perSecondHandler.apply(i, []);
                        });
                }
            },
        ...
        s = {
            ...
            getSecondsToDeadLine: function (e, t) {
                ...
                if (((o = Math.floor(o)), t.periodic)) {
                    var n,
                        r,
                        a = s.getPeriodUnit(t.periodUnit),
                        d = e / (1e3 * a);
                    (d = Math.ceil(d)),
                        (d = Math.abs(d)),
                        o >= 0 ? ((r = d % t.periodInterval), (r = 0 == r ? t.periodInterval : r), (r -= 1)) : (r = t.periodInterval - (d % t.periodInterval)),
                        (n = o % a),
                        0 == n && o < 0 && r--,
                        (i = Math.abs(r * a + n));
                } else i = o;

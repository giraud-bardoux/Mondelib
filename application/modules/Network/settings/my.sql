...
('user_settings_network', 'network', 'Networks', 'User_Plugin_Menus', '{"route":"user_extended", "module":"user", "controller":"settings", "action":"network", "icon":"fas fa-flag"}', 'user_settings', '', 5);

 ...
 * @version    $Id: Conversation.php 10009 2013-03-26 23:25:57Z jung $
 * @author     John
 */
...
class Messages_Model_Conversation extends Core_Model_Item_Abstract
{
  ...
  public function getDescription()
  {
    ...
    if( null !== $message ) {
      ...
      if($editor == 'editor') {
          return html_entity_decode(Engine_Text_Emoji::decode($message->body));
      } else {
        return nl2br(html_entity_decode(Engine_Text_Emoji::decode($message->body)));
      }
    }

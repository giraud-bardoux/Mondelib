...
class Messages_MessagesController extends Core_Controller_Action_User
{
  ...
  public function viewAction()
  {
    ...
    // Otherwise get recipients
        ...
        $viewer_blocker = "";
        //store conversation recepients except current viewer
        ...
        $this->view->recipients = $conversationRecepients;
  ...
  public function deleteAction()
  {
    ...
    try {
      foreach ($messages as $message_id) {
        $recipients = Engine_Api::_()->getItem('messages_conversation', $message_id);
        if($recipients) {
          $recipients = $recipients->getRecipientsInfo();

 ...
 * @license    http://www.socialengine.com/license/
 */
class Poll_Model_Photo extends Core_Model_Item_Collectible
{
    protected $_parent_type = 'poll_album';

    protected $_owner_type = 'user';

    protected $_collection_type = 'poll_album';
    ...
    public function getHref($params = array())
    {
        $params = array_merge(array(
            ...
            'controller' => 'photo',
            'action' => 'view',
            'poll_id' => $this->getCollection()->getOwner()->getIdentity(),
    ...
    public function getPoll()
    {
        ...
        //return $this->getCollection()->getPoll();
    }
    ...
    protected function _postDelete()
    {
        ...
        try {
            ...
            if( (int) $album->photo_id == (int) $this->getIdentity() ) {
                $album->photo_id = 0; //$this->getNextCollectible()->getIdentity();
                $album->save();
            }
        }
        catch( Exception $e )
